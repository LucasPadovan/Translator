...
class DescriptionsControllerTest < ActionController::TestCase
  ...
  test "should create description" do
    assert_difference('Description.count') do
      post :create, description: { description: @description.description, word_id: @description.word_id, word_type_id: @description.word_type_id }
    end
  ...
  test "should update description" do
    put :update, id: @description, description: { description: @description.description, word_id: @description.word_id, word_type_id: @description.word_type_id }
    assert_redirected_to description_path(assigns(:description))
  end
